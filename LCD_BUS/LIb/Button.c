...
__weak void btn_pressing_callback(Button_Typedf *ButtonX)
{
}
__weak void btn_press_short_callback(Button_Typedf *ButtonX)
{
}
__weak void btn_release_callback(Button_Typedf *ButtonX)
{
}
__weak void btn_press_timeout_callback(Button_Typedf *ButtonX)
{
